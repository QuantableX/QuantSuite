...
impl MinimalIme {
  // Backport of tao#1215: `more_char_coming` is peeked by the event loop
  // *before* the window-state lock is taken — peeking here, with the lock
  // held, could re-enter the window proc and deadlock the main thread.
